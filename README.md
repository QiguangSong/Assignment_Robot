...
#### 5. Provide a test report generated by Robot Framework. What issues have been discovered and what defects would you submit?   
   ...
   * Delete a non exsitent payment ID should fail and get 404 error       
   * Create a payment with amount but given a string get 500 error, this is not covered in the flask handler
